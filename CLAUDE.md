...
- **Feature Flags:** `AUTO_APPROVE` (die früher gelisteten `SHOW_VOTING`/`REQUIRE_AUTH` waren nie im Code verdrahtet und wurden 2026-07-07 entfernt — Voting ist immer aktiv, Auth strukturell via fastapi-users/Route-Guards)
